 ...
 *
 */
public class ProfessoresListView {

	public ProfessoresListView(ListController controller) {
		...
		insertOneButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				new ProfessoresFormView(controller,false,0);
			}
		});
		...
		updateButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (row == -1) {
					...
					new ProfessoresFormView(controller, true,table.getValueAt(row, 0));
				}
			}
		});
		...
		tableScrollPane.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(),
				"Lista de Professores", TitledBorder.CENTER, TitledBorder.TOP));
